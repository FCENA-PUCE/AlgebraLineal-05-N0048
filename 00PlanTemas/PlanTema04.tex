...
\begin{enumerate}[leftmargin=*]
    ...
    \item ¿Cómo se puede usar el determinante para encontrar el área de un paralelogramo definido por dos vectores en $\mathbb{R}^2$?
    \item ¿Cómo se puede usar el determinante para encontrar el volumen de un paralelepípedo definido por tres vectores en $\mathbb{R}^3$?
\end{enumerate}
