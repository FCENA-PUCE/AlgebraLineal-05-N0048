...
\begin{multi}[]%
    ...
    \item \(\|u\| = u \cdot u\)
    \item \(\|u\| = \sqrt{u_1 + u_2 + \cdots + u_n}\)
    \item \(\|u\| = u_1 + u_2 + \cdots + u_n\)
\end{multi}
...
\begin{multi}[]%
    ...
    \item* Sí, porque contiene al vector cero y es cerrado bajo suma y multiplicación por escalar.
    \item No, porque sus vectores no son ortogonales entre sí.
    \item No, porque el conjunto tiene infinitos vectores.
    \item Sí, pero solo si se incluyen todos los vectores de \(\mathbb{R}^2\).
\end{multi}
...
\begin{multi}[]%
    ...
    \item* \(\{(x,y,0)\in\mathbb{R}^3:\ x,y\in\mathbb{R}\}\)
    \item \(\{(x,0,0)\in\mathbb{R}^3:\ x\in\mathbb{R}\}\)
    \item \(\mathbb{R}^3\)
    \item \(\{(0,0,0)\}\)
\end{multi}
...
\begin{multi}[]%
    ...
    \item* Sí, porque ninguno de los vectores es múltiplo escalar del otro.
    \item No, porque ambos vectores tienen componentes distintas de cero.
    \item No, porque son solo dos vectores en \(\mathbb{R}^3\).
    \item Sí, porque su suma es distinta de cero.
\end{multi}
...
\begin{multi}[]%
    ...
    \item* linealmente dependiente, porque \((3,6)=3(1,2)\).
    \item linealmente independiente, porque los vectores son distintos.
    \item linealmente independiente, porque tienen dos componentes.
    \item linealmente dependiente, porque su producto punto no es cero.
\end{multi}
...
\begin{multi}[]%
    ...
    \item* única.
    \item múltiple, con infinitas formas posibles.
    \item única solo si \(v\) pertenece a \(B\).
    \item no necesariamente posible.
\end{multi}
...
\begin{numerical}[tolerance=0]%
    ...
    {Dimension-11}
    % - Enunciado
    ¿Cuál es la dimensión del espacio vectorial \(\mathbb{R}^{3\times 2}\) de todas las matrices de \(3\times 2\)?
    \item 6
\end{numerical}
...
\begin{multi}[]%
    ...
    \item \(\begin{pmatrix}1\\2\end{pmatrix}\)
    \item \(\begin{pmatrix}3\\1\end{pmatrix}\)
\end{multi}
...
\begin{multi}[]%
    ...
    {ApLin-11}
    % - Enunciado
    ¿Cuál de las siguientes aplicaciones \(T:\mathbb{R}^2\to\mathbb{R}^2\) NO es lineal?
    \item* \(T(x,y)=(x+1,y)\)
    \item \(T(x,y)=(x+y,0)\)
    \item \(T(x,y)=(2x,3y)\)
    \item \(T(x,y)=(x-y,x+y)\)
...
\begin{multi}[]%
    ...
    {ApLin-12}
    % - Enunciado
    Sea \(T:\mathbb{R}^3\to\mathbb{R}^2\) una aplicación lineal con \(\dim(\mathrm{Im}(T))=2\). ¿Cuál es \(\dim(\ker(T))\)?
    \item* \(1\)
    \item \(0\)
    \item \(2\)
    \item \(3\)
...
\begin{multi}[]%
    ...
    {ApLin-13}
    % - Enunciado
    Sea \(T:\mathbb{R}^2\to\mathbb{R}^2\) definida por \(T(x,y)=(x+y,\,2x-y)\). ¿Cuál es \(T(-1,3)\)?
    \item* \((2,-5)\)
    \item \((-1,3)\)
    \item \((2,5)\)
    \item \((-2,5)\)
