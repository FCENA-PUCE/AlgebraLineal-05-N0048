...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Revisión de la página:} se revisará la entrada \href{https://alephsub0.org/material-nuevo/acaicedo/determinar-espacio-generado/}{Determinar espacio generado}, para observar cómo expresar un subespacio mediante restricciones lineales sobre sus coordenadas.
\end{itemize}
...
Visualizar el video \href{https://youtu.be/kYB8IZa5AuE?si=gbqAeTULCuLFypRi}{Transformaciones lineales y matrices} y realizar la lectura de la sección 4.7 del libro de Larson.
